...
export function ShareOnXButton({ typeName }: ShareOnXButtonProps) {
  const href = buildTweetUrl(typeName, SITE_URL);
  ...
  return (
    <a
      ...
      onClick={(event) => {
        ...
        window.open(buildTweetUrl(typeName, origin), "_blank", "noopener,noreferrer");
      }}
